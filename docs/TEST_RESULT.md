...
[최신 검증 범위·사진·영상·한계](VALIDATION_20260917.md)를 먼저 확인하세요.

| 시험 | 결과 | 범위 |
| --- | --- | --- |
| 2026-09-16 월드 1~5 r8/r9 | 5/5 PASS, 문 회전 16/16 | 보존 주행 코드, 저장 지도, sim_odom, 기존 힌지 명령 backend |
| 2026-09-17 r40 | PASS, 유지 개방 117.72도 | 단일문 물리 접촉, 손잡이 유지, 해제·회수·후진 포함 |
| 이번 동기화의 스크립트 테스트 | 212 PASS | 코드 회귀 테스트이며 새 Gazebo FULL은 아님 |
| 새 물리 개방 결합 월드 1~5 | 미검증 | 위 두 PASS를 결합한 결과로 주장하지 않음 |

아래는 날짜별 원본 기록입니다. 당시 기준/모델과 최신 시험 조건이 다릅니다.
