...
- 개발 코드: `codex/world1-contact-integration-20260916`. 단일문 r40 손잡이 유지 접촉 개방·복귀 PASS.
- 보존 주행: `codex/feedback-resume-20260914` / `d1ffb39`. 2026-09-16 월드 1~5 PASS, 기존 힌지 backend 사용.
- 보고서: [REV6 읽는 순서](reports/2026-09-17/00_읽는순서.md).
- 한계와 증거: [2026-09-17 검증 결과](VALIDATION_20260917.md). 주행 5개 월드 PASS와 새 접촉 단일문 PASS를 합쳐 물리 접촉 다문 FULL로 해석하면 안 됩니다.
- 손잡이 v3는 r40에서 주 YOLO 기원 관측 38회를 기록했습니다. 아래 과거의 "직접 검출 0건"은 9월 7일 상태입니다. v2는 보조/실물 기본값으로 유지합니다.
- 실물 PIPER, 힘 제어, 새 물리 개방의 다문 미션은 미검증입니다. 이번 동기화 시 스크립트 테스트 212개 PASS.
