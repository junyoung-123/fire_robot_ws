...
export CONTACT_ANGLE_CONTROLLER="${CONTACT_ANGLE_CONTROLLER:-minimal_observed_angle_node}"
export CONTACT_HANDLE_INFERENCE_SIZE="${CONTACT_HANDLE_INFERENCE_SIZE:-320}"
